...
```{r, echo=FALSE, warning=FALSE}
andmed <- read.table("https://github.com/Rkursus/2022/raw/master/data/mass.txt", sep="\t", header=T)
mk <- read.table("https://github.com/Rkursus/2022/raw/master/data/maakonnad.txt", sep = " ")
library(ggplot2)
```
...
visiidid <- read.table("https://github.com/Rkursus/2022/raw/master/data/visiidid.txt", sep = "\t", header = TRUE)[1:5, ]
str(visiidid)
...
inimesed <- read.table("https://github.com/Rkursus/2022/raw/master/data/isikud.txt", sep = "\t", header = TRUE)
...
visiidid <- read.table("https://github.com/Rkursus/2022/raw/master/data/visiidid.txt", sep = "\t", header = TRUE)
inimesed <- read.table("https://github.com/Rkursus/2022/raw/master/data/isikud.txt", sep = "\t", header = TRUE)
m <- merge(inimesed, visiidid, by = "ik")
ggplot(data = m, 
       aes(x = as.Date(visiidi_kp), y = vererohk, 
...
<!--1. Loe sisse andmestik: `read.table("https://github.com/Rkursus/2022/raw/master/data/maakonnad.txt", sep = " ", header=T)`-->
