...
`mass <- read.table("https://github.com/Rkursus/2022/raw/master/data/mass.txt", sep = "\t", header = TRUE)` \newline
...
```{r, eval=FALSE, include=FALSE}
visiidid <- read.table("https://github.com/Rkursus/2022/raw/master/data/visiidid.txt", sep = "\t",
                       header = TRUE)
