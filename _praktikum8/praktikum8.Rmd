...
```{r, eval=FALSE, include=FALSE}
mass <- read.table("https://github.com/Rkursus/2022/raw/master/data/mass.txt", sep = "\t", header=T)
...
#2
# 1
isikukoodid <- read.table("https://github.com/Rkursus/2022/raw/master/data/isikukoodid.txt")[1,]
